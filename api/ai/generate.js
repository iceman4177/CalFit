  ...
  if (feature === "pose_session" || feature === "pose_session_beta") {
    ...
    try {
      ...
      const userText =
        ...
        "If recent physique memory is provided, compare today's look against that recent baseline in a believable, positive-only way. Favor trend language like sharper than your recent baseline, stronger than your recent baseline, more polished than your recent baseline, or more complete than your recent baseline when the structured numbers support it. When describing what could level up next, frame it as upside, amplification, or room to build on existing strengths rather than a missing trait. " +
        ...
        "Highlights should be positive-only and specific. Levers should be actionable: protein, training frequency, steps, sleep, re-scan consistency. Phrase growth areas as positive upside, not deficiency. Avoid wording that could feel discouraging, corrective, or body-negative. shareCardSummary should sound like a premium distilled version of the analysis, not generic app copy.";
