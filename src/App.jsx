...
export default function WorkoutPage({ userData, onWorkoutLogged }) {
  ...
  const WORKOUT_HISTORY_KEY = userId ? scopedKey(KEYS.workoutHistory, userId) : KEYS.workoutHistory;
  ...
  useEffect(() => {
    ...
    const onStorage = (e) => {
      if (!e) return;
      if (e.key === WORKOUT_HISTORY_KEY) readTodaySessionsFromLocal();
    };
    const onVisible = () => {
