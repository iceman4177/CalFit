...
export default function AIFoodLookupBox({ onAddFood }) {
    ...
    <Card sx={{ mb: 2 }}>
      <CardContent>
        <Typography variant="h6" gutterBottom>
          AI Food Lookup <Chip size="small" color="primary" label="PRO" sx={{ ml: 1 }} />
        </Typography>
      ...
      <UpgradeModal
        ...
        description="AI Food Lookup is a Pro feature. Upgrade to log foods by typing brand + quantity."
      />
    </Card>
  );
}
